...
| --- | --- | --- |
| `PROFILES.bat` | Настраивает профили подключения | Только то, что нужно конкретному контуру |
| `SETUP.bat` | Настраивает рабочую область | Папка, режим доступа, готовый профиль |
| `START.bat` | Запускает сервер | Только выбор рабочей области |

**Семь профилей подключения:**
