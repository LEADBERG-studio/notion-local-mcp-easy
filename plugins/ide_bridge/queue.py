...
pending request via ide_bridge_wait_request and completes it via
ide_bridge_send_response / ide_bridge_fail_request.
...
def wait_request(arguments: dict[str, Any], context: dict[str, Any], config: dict[str, Any]) -> dict[str, Any]:
    from plugins.ide_bridge.state import normalize_name, runtime_root
    ...
    return {
        ...
        "instructions_hint": (
            ...
            "ide_bridge_send_response (with content for text answers, or payload "
            "for images/embeddings/moderations) or ide_bridge_fail_request."
        ),
    }


def send_response(arguments: dict[str, Any], context: dict[str, Any], config: dict[str, Any]) -> dict[str, Any]:
    from plugins.ide_bridge.state import runtime_root
